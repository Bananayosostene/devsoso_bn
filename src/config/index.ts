...
export const DOCKER_POSTGRES_PORT = parseInt(process.env.DOCKER_POSTGRES_PORT || '5432', 10);
export const DOCKER_LOCAL_PORT = parseInt(process.env.DOCKER_LOCAL_PORT || '8080', 10);
...
export const NODEMAILER_EMAIL_PORT = parseInt(process.env.NODEMAILER_EMAIL_PORT || '587', 10);
...
export const PASSWORD_EXPIRATION_TIME = parseInt(process.env.PASSWORD_EXPIRATION_TIME || '90', 10);
